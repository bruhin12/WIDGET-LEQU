...
<style>
  :root{
    --bgA: rgba(6,7,8,0.94);
    --bgB: rgba(12,14,16,0.58);
    --txt: rgba(255,255,255,0.92);
    --muted: rgba(255,255,255,0.62);

    --g: rgba(78,255,155,0.95);
    --g2: rgba(22,200,120,0.95);
    --r: rgba(255,110,110,0.95);
    --y: rgba(255,210,90,0.95);

    --shadow: 0 14px 44px rgba(0,0,0,0.46);
  ...
  .bar{
    ...
    background:
      ...
      radial-gradient(320px 140px at 20% 30%, rgba(78,255,155,0.10), transparent 62%),
  ...
  .line{
    ...
    background: linear-gradient(90deg, transparent, rgba(78,255,155,0.95), transparent);
    opacity:.95;
    pointer-events:none;
  ...
  .flame:before{
    ...
    background: radial-gradient(circle at 35% 35%,
      ...
      rgba(78,255,155,0.95) 40%,
      rgba(22,200,120,0.45) 70%,
  ...
  .flame:after{
    ...
    background: linear-gradient(90deg,
      rgba(78,255,155,0.00),
      rgba(78,255,155,0.22),
      rgba(78,255,155,0.00));
    filter: blur(7px);
    opacity: .85;
  ...
  .champ.win{ box-shadow: 0 0 0 2px rgba(78,255,155,0.65) inset; }
  .champ.loss{ box-shadow: 0 0 0 2px rgba(255,110,110,0.70) inset; }

  .resultbar{
    position:absolute; left:0; right:0; bottom:0; height:4px;
    opacity:.95;
  }
  .resultbar.win{ background: linear-gradient(90deg, rgba(78,255,155,0.95), rgba(22,200,120,0.95)); }
  .resultbar.loss{ background: linear-gradient(90deg, rgba(255,110,110,0.95), rgba(255,70,70,0.95)); }
...
<script>
  ...
  async function refresh(){
    ...
    document.getElementById("sessWL").innerHTML =
      \`<span style="color: var(--g);">\${sw}</span><span style="color: rgba(255,255,255,0.80);">-</span><span style="color: var(--r);">\${sl}</span>\`;
